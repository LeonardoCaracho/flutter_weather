...
void main() {
  ...
  group('ThemeCubit', () {
    ...
    group('updateTheme', () {
      final clearWeather = MockWeather(weather_repository.WeatherCondition.clear);
      final snowyWeather = MockWeather(weather_repository.WeatherCondition.snowy);
      final cloudyWeather = MockWeather(weather_repository.WeatherCondition.cloudy);
      final rainyWeather = MockWeather(weather_repository.WeatherCondition.rainy);
      final unknownWeather = MockWeather(weather_repository.WeatherCondition.unknown);
